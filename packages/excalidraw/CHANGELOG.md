...
- Когда хост засеял настройки инструментов, после Esc, снятия замка и возврата из ластика или руки текущие цвет, толщина и прозрачность берутся из набора нового инструмента: правка выделенной фигуры больше не переносит в набор фигур толщину и прозрачность маркера или карандаша [#15](https://github.com/emevart/sdamexdraw/pull/15).
